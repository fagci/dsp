...
const SHELL=[
  ...
  './core-engine.js?v=11',
  './modules/analysis.js?v=11',
  './modules/misc.js?v=11',
  './modules/modulation.js?v=11',
  './modules/output.js?v=11',
  './modules/processing.js?v=11',
  './modules/protocols.js?v=11',
  './modules/sources.js?v=11',
  './modules/hfdl.js?v=11',
  './presets.js?v=11',
  './core-graph.js?v=11',
];
