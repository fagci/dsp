...
const SHELL=[
  ...
  './core-engine.js?v=25',
  './modules/analysis.js?v=25',
  './modules/misc.js?v=25',
  './modules/modulation.js?v=25',
  './modules/output.js?v=25',
  './modules/processing.js?v=25',
  './modules/protocols.js?v=25',
  './modules/sources.js?v=25',
  './modules/hfdl.js?v=25',
  './presets.js?v=25',
  './core-graph.js?v=25',
];
