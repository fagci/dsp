...
const SHELL=[
  ...
  './core-engine.js?v=13',
  './modules/analysis.js?v=13',
  './modules/misc.js?v=13',
  './modules/modulation.js?v=13',
  './modules/output.js?v=13',
  './modules/processing.js?v=13',
  './modules/protocols.js?v=13',
  './modules/sources.js?v=13',
  './modules/hfdl.js?v=13',
  './presets.js?v=13',
  './core-graph.js?v=13',
];
