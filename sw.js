...
const SHELL=[
  ...
  './core-engine.js?v=33',
  './modules/analysis.js?v=33',
  './modules/misc.js?v=33',
  './modules/modulation.js?v=33',
  './modules/output.js?v=33',
  './modules/processing.js?v=33',
  './modules/protocols.js?v=33',
  './modules/sources.js?v=33',
  './modules/hfdl.js?v=33',
  './presets.js?v=33',
  './core-graph.js?v=33',
];
