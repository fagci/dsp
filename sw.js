...
const SHELL=[
  ...
  './core-engine.js?v=8',
  './modules/analysis.js?v=8',
  './modules/misc.js?v=8',
  './modules/modulation.js?v=8',
  './modules/output.js?v=8',
  './modules/processing.js?v=8',
  './modules/protocols.js?v=8',
  './modules/sources.js?v=8',
  './modules/hfdl.js?v=8',
  './presets.js?v=8',
  './core-graph.js?v=8',
];
