...
const SHELL=[
  ...
  './core-engine.js?v=28',
  './modules/analysis.js?v=28',
  './modules/misc.js?v=28',
  './modules/modulation.js?v=28',
  './modules/output.js?v=28',
  './modules/processing.js?v=28',
  './modules/protocols.js?v=28',
  './modules/sources.js?v=28',
  './modules/hfdl.js?v=28',
  './presets.js?v=28',
  './core-graph.js?v=28',
];
