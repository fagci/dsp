...
const SHELL=[
  ...
  './core-engine.js?v=20',
  './modules/analysis.js?v=20',
  './modules/misc.js?v=20',
  './modules/modulation.js?v=20',
  './modules/output.js?v=20',
  './modules/processing.js?v=20',
  './modules/protocols.js?v=20',
  './modules/sources.js?v=20',
  './modules/hfdl.js?v=20',
  './presets.js?v=20',
  './core-graph.js?v=20',
];
