...
const SHELL=[
  ...
  './core-engine.js?v=31',
  './modules/analysis.js?v=31',
  './modules/misc.js?v=31',
  './modules/modulation.js?v=31',
  './modules/output.js?v=31',
  './modules/processing.js?v=31',
  './modules/protocols.js?v=31',
  './modules/sources.js?v=31',
  './modules/hfdl.js?v=31',
  './presets.js?v=31',
  './core-graph.js?v=31',
];
