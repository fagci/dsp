...
const SHELL=[
  ...
  './core-engine.js?v=7',
  './modules/analysis.js?v=7',
  './modules/misc.js?v=7',
  './modules/modulation.js?v=7',
  './modules/output.js?v=7',
  './modules/processing.js?v=7',
  './modules/protocols.js?v=7',
  './modules/sources.js?v=7',
  './modules/hfdl.js?v=7',
  './presets.js?v=7',
  './core-graph.js?v=7',
];
