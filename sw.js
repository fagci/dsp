...
const SHELL=[
  ...
  './core-engine.js?v=9',
  './modules/analysis.js?v=9',
  './modules/misc.js?v=9',
  './modules/modulation.js?v=9',
  './modules/output.js?v=9',
  './modules/processing.js?v=9',
  './modules/protocols.js?v=9',
  './modules/sources.js?v=9',
  './modules/hfdl.js?v=9',
  './presets.js?v=9',
  './core-graph.js?v=9',
];
