...
const SHELL=[
  ...
  './core-engine.js?v=24',
  './modules/analysis.js?v=24',
  './modules/misc.js?v=24',
  './modules/modulation.js?v=24',
  './modules/output.js?v=24',
  './modules/processing.js?v=24',
  './modules/protocols.js?v=24',
  './modules/sources.js?v=24',
  './modules/hfdl.js?v=24',
  './presets.js?v=24',
  './core-graph.js?v=24',
];
