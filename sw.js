...
const SHELL=[
  ...
  './core-engine.js?v=15',
  './modules/analysis.js?v=15',
  './modules/misc.js?v=15',
  './modules/modulation.js?v=15',
  './modules/output.js?v=15',
  './modules/processing.js?v=15',
  './modules/protocols.js?v=15',
  './modules/sources.js?v=15',
  './modules/hfdl.js?v=15',
  './presets.js?v=15',
  './core-graph.js?v=15',
];
