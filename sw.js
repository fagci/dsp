...
const SHELL=[
  ...
  './core-engine.js?v=12',
  './modules/analysis.js?v=12',
  './modules/misc.js?v=12',
  './modules/modulation.js?v=12',
  './modules/output.js?v=12',
  './modules/processing.js?v=12',
  './modules/protocols.js?v=12',
  './modules/sources.js?v=12',
  './modules/hfdl.js?v=12',
  './presets.js?v=12',
  './core-graph.js?v=12',
];
