...
const SHELL=[
  ...
  './core-engine.js?v=23',
  './modules/analysis.js?v=23',
  './modules/misc.js?v=23',
  './modules/modulation.js?v=23',
  './modules/output.js?v=23',
  './modules/processing.js?v=23',
  './modules/protocols.js?v=23',
  './modules/sources.js?v=23',
  './modules/hfdl.js?v=23',
  './presets.js?v=23',
  './core-graph.js?v=23',
];
