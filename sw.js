...
const SHELL=[
  ...
  './core-engine.js?v=32',
  './modules/analysis.js?v=32',
  './modules/misc.js?v=32',
  './modules/modulation.js?v=32',
  './modules/output.js?v=32',
  './modules/processing.js?v=32',
  './modules/protocols.js?v=32',
  './modules/sources.js?v=32',
  './modules/hfdl.js?v=32',
  './presets.js?v=32',
  './core-graph.js?v=32',
];
