...
const SHELL=[
  ...
  './core-engine.js?v=18',
  './modules/analysis.js?v=18',
  './modules/misc.js?v=18',
  './modules/modulation.js?v=18',
  './modules/output.js?v=18',
  './modules/processing.js?v=18',
  './modules/protocols.js?v=18',
  './modules/sources.js?v=18',
  './modules/hfdl.js?v=18',
  './presets.js?v=18',
  './core-graph.js?v=18',
];
