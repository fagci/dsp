...
const SHELL=[
  ...
  './core-engine.js?v=16',
  './modules/analysis.js?v=16',
  './modules/misc.js?v=16',
  './modules/modulation.js?v=16',
  './modules/output.js?v=16',
  './modules/processing.js?v=16',
  './modules/protocols.js?v=16',
  './modules/sources.js?v=16',
  './modules/hfdl.js?v=16',
  './presets.js?v=16',
  './core-graph.js?v=16',
];
