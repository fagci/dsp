...
const SHELL=[
  ...
  './core-engine.js?v=10',
  './modules/analysis.js?v=10',
  './modules/misc.js?v=10',
  './modules/modulation.js?v=10',
  './modules/output.js?v=10',
  './modules/processing.js?v=10',
  './modules/protocols.js?v=10',
  './modules/sources.js?v=10',
  './modules/hfdl.js?v=10',
  './presets.js?v=10',
  './core-graph.js?v=10',
];
