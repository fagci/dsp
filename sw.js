...
const SHELL=[
  ...
  './core-engine.js?v=14',
  './modules/analysis.js?v=14',
  './modules/misc.js?v=14',
  './modules/modulation.js?v=14',
  './modules/output.js?v=14',
  './modules/processing.js?v=14',
  './modules/protocols.js?v=14',
  './modules/sources.js?v=14',
  './modules/hfdl.js?v=14',
  './presets.js?v=14',
  './core-graph.js?v=14',
];
