...
const SHELL=[
  ...
  './core-engine.js?v=17',
  './modules/analysis.js?v=17',
  './modules/misc.js?v=17',
  './modules/modulation.js?v=17',
  './modules/output.js?v=17',
  './modules/processing.js?v=17',
  './modules/protocols.js?v=17',
  './modules/sources.js?v=17',
  './modules/hfdl.js?v=17',
  './presets.js?v=17',
  './core-graph.js?v=17',
];
